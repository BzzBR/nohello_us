...
## TL;DR  
Chat foi feito para **economizar tempo**.  
Enviar apenas **"Olá"** força a outra pessoa a esperar enquanto você digita a mensagem real.  
Envie sua saudação **e** sua pergunta juntas.
...
# COLEGA ESPERA ENQUANTO VOCÊ FORMULA SUA PERGUNTA  

  12:35 você:         Estou trabalhando em [algo] e tentando fazer [etc...]
  12:35 colega:       Aqui está a resposta...  
```  
